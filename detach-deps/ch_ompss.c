		...
		START_TIMING(TIME_TOTAL);
		{
			...
			for (int k = 0; k < nt; k++)
			{
				...
				if (block_rank[k*nt+k] != mype)
				{
					...
					///////////////////////////////////////////////////////////////////////////
					printf("Receive (POTRF) done at %d\n" ,mype);
				}
